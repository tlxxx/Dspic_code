...
def get_parts_and_edges(label, partitioning):
    if label in ["half_cheetah", "HalfCheetah-v2", "HalfCheetah-v4"]:
        # define Mujoco graph
    ...
    elif label in ["Ant-v2", "Ant-v5", "Ant-v4"]:
        # define Mujoco graph
        torso = 1
        front_left_leg = 2
        aux_1 = 3
    ...
    elif label in ["Humanoid-v2", "HumanoidStandup-v2", "Humanoid-v4", "HumanoidStandup-v4"]:
        # define Mujoco-Graph
        abdomen_y = Node(
            "abdomen_y", -16, -16, 0
    ...
    elif label in ["Reacher-v2", "Reacher-v4"]:
        # define Mujoco-Graph
        body0 = 1
        body1 = 2
        fingertip = 3
    ...
    elif label in ["Walker2d-v2", "Walker2d-v5", "Walker2d-v4"]:
        # define Mujoco-Graph
